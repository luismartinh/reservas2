...
/**
 * GrupoAccesoController implements the CRUD actions for GrupoAcceso model.
 *
...
class GrupoAccesoController extends Controller
{
    ...
    /**
     * Finds the GrupoAcceso model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     *
     * @param integer $id
     *
     * @throws NotFoundHttpException if the model cannot be found
     * @return GrupoAcceso the loaded model
     */
    protected function findModel($id)
    {
        $model = GrupoAcceso::findOne($id);
        if ($model !== null) {
            return $model;
        }
