...
abstract class CabanaTarifa extends \yii\db\ActiveRecord
{
    ...
    /**
     * Evita superponer rangos de tarifas para la misma cabaña.
     * Considera superposición cuando el rango nuevo toca o intersecta otro
     * (es decir, sólo NO se superpone si new_fin < old_inicio OR new_inicio > old_fin).
     */
    ...
    public function attributeHints()
    {
        return ArrayHelper::merge(parent::attributeHints(), [
            'id' => Yii::t('models', 'ID'),
            'id_cabana' => Yii::t('models', 'Seleccione la Cabaña'),
