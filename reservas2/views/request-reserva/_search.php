 ...
 * @var app\models\RequestReservaSearch $model
 * @var kartik\form\ActiveForm $form
 */
?>

<div class="request-reserva-search">
	...
	<div class="row">
		...
		<div class="col-md-3"> 
				...
				echo $form->field($model, 'impagas')->checkbox([
					'custom' => true,
					'switch' => true,
				])->hint('Filtrar pendientes de pago');
		...
		<div class="col-md-3"> 
				...
				echo $form->field($model, 'vencidas')->checkbox([
					'custom' => true,
					'switch' => true,
				])->hint('Filtrar solicitudes vencidas');
