...
/**
 * LocadorController implements the CRUD actions for Locador model.
 *
...
class LocadorController extends Controller
{
    ...
    /**
     * Finds the Locador model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     *
     * @param integer $id
     *
     * @throws NotFoundHttpException if the model cannot be found
     * @return Locador the loaded model
     */
    protected function findModel($id)
    {
        $model = Locador::findOne($id);
        if ($model !== null) {
            return $model;
        }
