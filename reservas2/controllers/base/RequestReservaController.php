...
/**
 * RequestReservaController implements the CRUD actions for RequestReserva model.
 *
 * @property-read Request $request
 */
class RequestReservaController extends Controller
{
    ...
    /**
     * Displays a single RequestReserva model.
     *
     * @param integer $id
     *
    ...
    /**
     * Creates a new RequestReserva model.
    ...
    {
        $model = Yii::createObject(RequestReserva::class);
        try {
    ...
    /**
     * Updates an existing RequestReserva model.
    ...
    /**
     * Finds the RequestReserva model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     *
     * @param integer $id
     *
     * @throws NotFoundHttpException if the model cannot be found
     * @return RequestReserva the loaded model
     */
