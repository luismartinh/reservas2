...
/**
 * ParametrosGeneralesController implements the CRUD actions for ParametrosGenerales model.
 *
...
class ParametrosGeneralesController extends Controller
{
                ...
                'access' => [
                    ...
                    'rules' => [
                        [
                            ...
                            'roles' => ['AppParametrosGeneralesFull']
                        ],
                        [
                            'allow' => true,
                            'actions' => ['index', 'view'],
                            'roles' => ['AppParametrosGeneralesView']
                        ],
                        [
                            'allow' => true,
                            'actions' => ['update', 'create', 'delete'],
                            'roles' => ['AppParametrosGeneralesEdit']
                        ],
                    ]
                ]
            ]
    ...
    {
        $model = Yii::createObject(ParametrosGenerales::class);
        try {
    ...
    /**
     * Finds the ParametrosGenerales model based on its primary key value.
    ...
    {
        $model = ParametrosGenerales::findOne($id);
        if ($model !== null) {
            return $model;
        }
